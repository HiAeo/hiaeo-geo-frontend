<template>
  <div class="admin-layout" :data-theme="theme">
    ...
    <aside class="sidebar" :class="{ collapsed: sidebarCollapsed }">
      <div class="sidebar-header">
        <div class="logo">
          ...
          <span v-if="!sidebarCollapsed" class="logo-text">HiAeo Admin</span>
        </div>
      ...
      <div class="sidebar-footer">
        ...
        <button class="nav-item" @click="$emit('logout')">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <main class="main-content">
      ...
      <!-- Credits Tab -->
      <div v-else-if="activeTab === 'credits'" class="tab-content">
        <CreditsPage :theme="theme" />
      </div>

      <!-- Diagnose Tab -->
      <div v-else-if="activeTab === 'diagnose'" class="tab-content">
        <DiagnosePage :theme="theme" />
      </div>
...
import UsersPage from './AdminUserPage.vue'
import CreditsPage from './CreditsPage.vue'
import DiagnosePage from './DiagnosePage.vue'
...
const emit = defineEmits(['toggle-theme', 'logout', 'back'])
...
const navItems = [
  ...
  { id: 'diagnose', label: '诊断报告', icon: DiagnoseIcon },
  { id: 'users', label: '用户管理', icon: UsersIcon },
  { id: 'credits', label: '积分管理', icon: CreditsIcon },
