...
const RULES: KBRule[] = [
  ...
  // ---- P2: 产品功能 ----
  {
    ...
    reply: '**360智见** 是国内首个面向企业的AI生成式引擎优化（GEO）全闭环SaaS平台。\n\n## 🎯 四大核心模块\n\n### 1️⃣ 模镜 MiraSeek — AI可见度诊断\n- 7维度品牌健康评分体系\n- AI可见度全方位检测与竞品对比\n\n### 2️⃣ 模豆 MiraMod — 智能策略生成\n- AI驱动的GEO优化策略自动生成\n- 多场景定制化方案 + 效果预测\n\n### 3️⃣ 模法 MiraMag — 内容生成执行\n- 自动化GEO友好内容生产\n- 多渠道分发管理与效果追踪\n\n### 4️⃣ 魔鲸Hub — 统一管理驾驶舱\n- 实时数据看板 + 趋势预警\n- 全局ROI评估与决策支持\n\n> 🔗 欢迎使用360智见，开启您的GEO优化之旅！',
  },
